...
class GameScene3: SKScene, SKPhysicsContactDelegate {
    ...
    let remainingRoundMultiplier:Int = 15
    let remainingTimeMultiplier:Int = 5
    ...
    override func didMoveToView(view: SKView) {
        ...
        let enemyOnePatrolOne = SKAction.moveByX(-1805.0, y: 0.0, duration: 3.0)
        ...
        let enemyOnePatrolTwo = SKAction.moveByX(1805.0, y: 0.0, duration: 3.0)
        ...
        let enemyTwoPatrolOne = SKAction.moveByX(1805.0, y: 0.0, duration: 4.0)
        // set the timing mode for the first half of the animation
        enemyTwoPatrolOne.timingMode = .EaseInEaseOut
        
        // create the second animation for the second half of the patrol for enemy 2
        let enemyTwoPatrolTwo = SKAction.moveByX(-1805.0, y: 0.0, duration: 4.0)
        // set the timing mode for the second half of the animation
        ...
        let enemyThreePatrolOne = SKAction.moveByX(-1805.0, y: 0.0, duration: 1.5)
        // set the timing mode for the first half of the animation
        enemyOnePatrolOne.timingMode = .EaseInEaseOut
        
        // create the second animation for the second half of the patrol for enemy 3
        let enemyThreePatrolTwo = SKAction.moveByX(1805.0, y: 0.0, duration: 1.5)
        // set the timing mode for the second half of the animation
        enemyOnePatrolTwo.timingMode = .EaseInEaseOut
        ...
        // create the first animation for the first half of the patrol for enemy 2
        let enemyFourPatrolOne = SKAction.moveByX(1805.0, y: 0.0, duration: 2.0)
        // set the timing mode for the first half of the animation
        enemyFourPatrolOne.timingMode = .EaseInEaseOut
        
        // create the second animation for the second half of the patrol for enemy 2
        let enemyFourPatrolTwo = SKAction.moveByX(-1805.0, y: 0.0, duration: 2.0)
        // set the timing mode for the second half of the animation
    ...
    override func touchesBegan(touches: Set<UITouch>, withEvent event: UIEvent?) {
        ...
        for touch:AnyObject! in touches {
            ...
            if spriteName == "enemyOne" {
                ...
                let restartGame = GameScene3(fileNamed: "GameScene3")
